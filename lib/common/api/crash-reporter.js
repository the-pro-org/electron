...
const os = process.type === 'browser' ? require('os') : electron.remote.require('os')
const {spawn} = process.type === 'browser' ? require('child_process') : electron.remote.require('child_process')
